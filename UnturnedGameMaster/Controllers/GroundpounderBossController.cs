...
namespace UnturnedGameMaster.Controllers
{
    public class GroundpounderBossController : BossController<GroundpounderBoss>
    {
        ...
        public override bool Update()
        {
            ...
            // temp
            if (lastHealth != bossHealth)
            {
                ChatHelper.Say(fight.Participants, $"{bossHealth}%");
        ...
        private bool SpawnMinion(IZombieModel model)
        {
            ...
            ManagedZombie managedZombie = zombiePoolManager.SpawnZombie(arena.BoundId, 0, model, spawnPoint, 0f);
